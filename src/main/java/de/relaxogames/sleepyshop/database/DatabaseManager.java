...
public class DatabaseManager {
    ...
    public CompletableFuture<Void> saveShop(Shop shop) {
        ...
        return CompletableFuture.runAsync(
            () -> {
                String sql =
                    "INSERT OR REPLACE INTO shops (sign_location, chest_location, owner, sell_item, payment_item, " +
        ...
        CompletableFuture.runAsync(
            () -> {
                ...
                try (
                    ...
                    plugin
                        .getLogger()
                        .severe("Could not remove shop from SQLite!");
                }
            },
            executor
        );
        ...
        return CompletableFuture.supplyAsync(
            () -> {
                ...
                try (
                    ...
                    plugin
                        .getLogger()
                        .severe("Could not load shops from SQLite!");
                }
                return shops;
            },
            executor
